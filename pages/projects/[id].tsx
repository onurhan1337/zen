...
const ProjectDetailContent = ({
    ...
    return (
        <div
            ...
            <div
                className="flex w-full grid-cols-2 flex-row items-center justify-between space-x-4 sm:grid-cols-2 sm:justify-end">
                {isOwner ? (
                    ...
                    <div className="flex items-center justify-center space-x-2">
                        <TaskCreateContent/>
                        <DisconnectFromProject userId={session.user.id} projectId={project.id}/>
                    </div>
                )}
            </div>
        </div>
...
const PageLoadingState = () => {
    return (
        <div className="animate-pulse">
            <section className="flex w-full flex-col items-center">
                <div
                    className="flex w-full max-w-screen-xl flex-row items-center justify-between border-b border-zinc-700 pb-4">
